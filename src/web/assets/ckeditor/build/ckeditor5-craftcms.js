import { ImageInsertUI as qu, ButtonView as Cs, icons as eu, Plugin as rr, LinkUI as Xl, ContextualBalloon as Ku, createDropdown as _a, SplitButtonView as Qu, addListToDropdown as xa, Collection as Sa, ViewModel as $o, Range as Gu, Command as Ts, ImageUtils as tu, DropdownButtonView as Xu, Widget as Ju, viewToModelPositionOutsideModelElement as Zu, toWidget as ec, DomEventObserver as tc, WidgetToolbarRepository as Jl, isWidget as nc, ClassicEditor as rc, SourceEditing as Os, Heading as nu, Paragraph as oc, SelectAll as ic, Clipboard as ac, Alignment as sc, AutoImage as lc, AutoLink as uc, Autoformat as cc, BlockQuote as fc, Bold as dc, Code as pc, CodeBlock as hc, List as mc, ListProperties as gc, Essentials as bc, FindAndReplace as yc, Font as vc, GeneralHtmlSupport as kc, HorizontalLine as wc, HtmlComment as Ec, HtmlEmbed as _c, Image as xc, ImageCaption as Sc, ImageStyle as Cc, ImageToolbar as Tc, Indent as Oc, IndentBlock as Pc, Italic as Nc, LinkEditing as Dc, LinkImage as Rc, MediaEmbed as Ac, MediaEmbedToolbar as Mc, PageBreak as Ic, PasteFromOffice as jc, RemoveFormat as zc, Strikethrough as Lc, Style as Uc, Subscript as Fc, Superscript as Bc, Table as Wc, TableCaption as Hc, TableCellProperties as Vc, TableProperties as $c, TableToolbar as Yc, TableUI as qc, TextPartLanguage as Kc, TodoList as Qc, Underline as Gc, WordCount as Xc } from "ckeditor5";
/**
...
class Jc extends qu {
  ...
  _createToolbarImageButton(H) {
    ...
    d.isEnabled = !0, d.label = s("Insert image"), d.icon = eu.image, d.tooltip = !0;
...
class tf extends rr {
  ...
  init() {
    const H = this.editor;
    if (this._linkUI = H.plugins.get(Xl), this._balloon = H.plugins.get(Ku), this._createToolbarLinkButton(), Craft.isMultiSite) {
  ...
  _createToolbarLinkButton() {
    ...
    H.ui.componentFactory.add("link", (u) => {
      const o = _a(u, Qu), S = o.buttonView;
      return S.isEnabled = !0, S.label = d("Link"), S.icon = Zc, S.keystroke = ef, S.tooltip = !0, S.isToggleable = !0, this.listenTo(
        S,
        "execute",
...
class ru extends rr {
  ...
  init() {
    const H = this.editor, E = new nf(H);
...
class of extends rr {
  ...
  _registerImageTransformDropdown(H) {
    const E = this.editor, s = E.t, d = {
      ...
      const m = E.commands.get("transformImage"), g = _a(S, Xu), y = g.buttonView;
      return y.set({
  ...
  _getTransformDropdownListItemDefinitions(H, E) {
    ...
    return H.map((d) => {
      ...
      u.model.bind("isOn").to(E, "value", af(d.value)), s.add(u);
    }), s;
  }
}
function af(ke) {
...
class ou extends rr {
  ...
  init() {
    const H = this.editor, E = new lf(H);
...
class df extends rr {
  ...
  init() {
    ...
    const H = this.editor;
    H.commands.add("insertEntry", new ff(H)), H.editing.mapper.on(
      "viewToModelPosition",
      Zu(H.model, (E) => {
...
class hf extends rr {
  ...
  afterInit() {
    this.editor.plugins.get(
      ...
      getRelatedElement: (E) => {
        ...
        return s && nc(s) && s.hasClass("cke-entry-card") ? s : null;
      }
    });
  }
  /**
  ...
  _listenToEvents() {
    ...
    H.addObserver(pf), this.editor.listenTo(E, "dblclick", (s, d) => {
...
` : "";
    ...
    in ` + (r || "Unknown") + p;
        ...
        var uu = { eventTypes: ii, extractEvents: function(e, t, n, r, i, p) {
          ...
          return null;
        } }, cu = an.extend({ animationName: null, elapsedTime: null, pseudoElement: null }), fu = an.extend({ clipboardData: function(e) {
          return "clipboardData" in e ? e.clipboardData : window.clipboardData;
        } }), du = xt.extend({ relatedTarget: null });
        function Li(e) {
          var t = e.keyCode;
          return "charCode" in e ? (e = e.charCode) === 0 && t === 13 && (e = 13) : e = t, e === 10 && (e = 13), 32 <= e || e === 13 ? e : 0;
        }
        var pu = { Esc: "Escape", Spacebar: " ", Left: "ArrowLeft", Up: "ArrowUp", Right: "ArrowRight", Down: "ArrowDown", Del: "Delete", Win: "OS", Menu: "ContextMenu", Apps: "ContextMenu", Scroll: "ScrollLock", MozPrintableKey: "Unidentified" }, hu = { 8: "Backspace", 9: "Tab", 12: "Clear", 13: "Enter", 16: "Shift", 17: "Control", 18: "Alt", 19: "Pause", 20: "CapsLock", 27: "Escape", 32: " ", 33: "PageUp", 34: "PageDown", 35: "End", 36: "Home", 37: "ArrowLeft", 38: "ArrowUp", 39: "ArrowRight", 40: "ArrowDown", 45: "Insert", 46: "Delete", 112: "F1", 113: "F2", 114: "F3", 115: "F4", 116: "F5", 117: "F6", 118: "F7", 119: "F8", 120: "F9", 121: "F10", 122: "F11", 123: "F12", 144: "NumLock", 145: "ScrollLock", 224: "Meta" }, mu = xt.extend({ key: function(e) {
          if (e.key) {
            var t = pu[e.key] || e.key;
            if (t !== "Unidentified") return t;
          }
          return e.type === "keypress" ? (e = Li(e)) === 13 ? "Enter" : String.fromCharCode(e) : e.type === "keydown" || e.type === "keyup" ? hu[e.keyCode] || "Unidentified" : "";
        ...
        } }), gu = Lr.extend({ dataTransfer: null }), bu = xt.extend({ touches: null, targetTouches: null, changedTouches: null, altKey: null, metaKey: null, ctrlKey: null, shiftKey: null, getModifierState: $t }), yu = an.extend({ propertyName: null, elapsedTime: null, pseudoElement: null }), vu = Lr.extend({ deltaX: function(e) {
          return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
        }, deltaY: function(e) {
          return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
        }, deltaZ: null, deltaMode: null }), ku = { eventTypes: ki, extractEvents: function(e, t, n, r) {
          var i = wi.get(e);
          if (!i) return null;
          switch (e) {
            case "keypress":
        ...
        M = Array.prototype.slice.call("ResponderEventPlugin SimpleEventPlugin EnterLeaveEventPlugin ChangeEventPlugin SelectEventPlugin BeforeInputEventPlugin".split(" ")), R(), Q = ni, j = oo, W = Qn, le({ SimpleEventPlugin: ku, EnterLeaveEventPlugin: Mo, ChangeEventPlugin: zr, SelectEventPlugin: uu, BeforeInputEventPlugin: Ke });
        var Ma = [], jo = -1;
        function vt(e) {
        ...
        var wu = S.unstable_runWithPriority, Ia = S.unstable_scheduleCallback, Ms = S.unstable_cancelCallback, Is = S.unstable_requestPaint, ja = S.unstable_now, Eu = S.unstable_getCurrentPriorityLevel, Bi = S.unstable_ImmediatePriority, js = S.unstable_UserBlockingPriority, zs = S.unstable_NormalPriority, Ls = S.unstable_LowPriority, Us = S.unstable_IdlePriority, Fs = {}, _u = S.unstable_shouldYield, xu = Is !== void 0 ? Is : function() {
        ...
        function Ka(e, t, n, r, i, p) {
          if ($r = p, Lt = t, t.memoizedState = null, t.updateQueue = null, t.expirationTime = 0, Zi.current = e === null || e.memoizedState === null ? Su : Cu, e = n(r, i), t.expirationTime === $r) {
            p = 0;
            do {
              if (t.expirationTime = 0, !(25 > p)) throw Error(m(301));
              p += 1, Jt = sn = null, t.updateQueue = null, Zi.current = Tu, e = n(r, i);
        ...
        } }, Cu = { readContext: zn, useCallback: oa, useContext: zn, useEffect: ra, useImperativeHandle: il, useLayoutEffect: rl, useMemo: sl, useReducer: ta, useRef: tl, useState: function() {
          return ta(co);
        ...
        } }, Tu = { readContext: zn, useCallback: oa, useContext: zn, useEffect: ra, useImperativeHandle: il, useLayoutEffect: rl, useMemo: sl, useReducer: na, useRef: tl, useState: function() {
          return na(co);
        }, useDebugValue: Za, useResponder: Ya, useDeferredValue: function(e, t) {
        ...
        var Ou = he.ReactCurrentOwner, er = !1;
        function Un(e, t, n, r) {
        ...
        var Du = typeof WeakSet == "function" ? WeakSet : Set;
        function ls(e, t) {
        ...
        function Rl(e) {
          ...
          if (t !== null) {
            e.updateQueue = null;
            var n = e.stateNode;
            n === null && (n = e.stateNode = new Du()), t.forEach(function(r) {
              var i = Wu.bind(null, e, r);
        ...
        var Il, Iu = Math.ceil, la = he.ReactCurrentDispatcher, jl = he.ReactCurrentOwner, po = 0, ua = 3, ca = 4, Qe = 0, _n = null, Ge = null, mn = 0, Ft = po, fa = null, kr = 1073741823, di = 1073741823, da = null, pi = 0, pa = !1, cs = 0, Me = null, ha = !1, fs = null, qr = null, ma = !1, hi = null, mi = 90, ho = null, gi = 0, ds = null, ga = 0;
        function tr() {
            ...
            if (Vo(), e === _n && n === mn || go(e, n), Ge !== null) {
              ...
              if (Ge === null) switch (i = e.finishedWork = e.current.alternate, e.finishedExpirationTime = n, r = Ft, _n = null, r) {
                ...
                case ca:
                  ...
                  if (di !== 1073741823 ? r = 10 * (1073741821 - di) - jn() : kr === 1073741823 ? r = 0 : (r = 10 * (1073741821 - kr) - 5e3, 0 > (r = (i = jn()) - r) && (r = 0), (n = 10 * (1073741821 - n) - i) < (r = (120 > r ? 120 : 480 > r ? 480 : 1080 > r ? 1080 : 1920 > r ? 1920 : 3e3 > r ? 3e3 : 4320 > r ? 4320 : 1960 * Iu(r / 1960)) - r) && (r = n)), 10 < r) {
                ...
                if (t = mn, v.effectTag |= 2048, v.firstEffect = v.lastEffect = null, x !== null && typeof x == "object" && typeof x.then == "function") {
                  ...
                  do {
                    ...
                    if (He) {
                      ...
                      x = void 0, v = t;
                      var ce = i.pingCache;
                      if (ce === null ? (ce = i.pingCache = new Mu(), x = /* @__PURE__ */ new Set(), ce.set(X, x)) : (x = ce.get(X)) === void 0 && (x = /* @__PURE__ */ new Set(), ce.set(X, x)), !x.has(v)) {
                        x.add(v);
                        var ve = Bu.bind(null, i, X, v);
                        X.then(ve, ve);
                      }
...
Add a <Suspense fallback=...> component higher in the tree to provide a loading indicator or placeholder to display.` + xr(v));
        ...
        function Vl(e) {
          ...
          do {
            ...
            if (e = Ge.return, (2048 & Ge.effectTag) == 0) {
              if (t = Pu(t, Ge, mn), mn === 1 || Ge.childExpirationTime !== 1) {
              ...
              if ((t = Nu(Ge)) !== null) return t.effectTag &= 2047, t;
        ...
        function bo(e) {
          var t = Hi();
          return Br(99, Lu.bind(null, e, t)), null;
        }
        function Lu(e, t) {
          do
            Vo();
          ...
          if (e.firstPendingTime = i, r <= e.lastSuspendedTime ? e.firstSuspendedTime = e.lastSuspendedTime = e.nextKnownPendingLevel = 0 : r <= e.firstSuspendedTime && (e.firstSuspendedTime = r - 1), r <= e.lastPingedTime && (e.lastPingedTime = 0), r <= e.lastExpiredTime && (e.lastExpiredTime = 0), e === _n && (Ge = _n = null, mn = 0), 1 < n.effectTag ? n.lastEffect !== null ? (n.lastEffect.nextEffect = n, i = n.firstEffect) : i = n : i = n.firstEffect, i !== null) {
            ...
            do
              try {
                for (ve = e; Me !== null; ) {
                  var Be = Me.effectTag;
                  if (36 & Be && Au(ve, Me.alternate, Me), 128 & Be) {
                    xe = void 0;
                    var at = Me.ref;
                    if (at !== null) {
                      var Rt = Me.stateNode;
        ...
        function Uu() {
          for (; Me !== null; ) {
            var e = Me.effectTag;
            256 & e && Ru(Me.alternate, Me), !(512 & e) || ma || (ma = !0, Hs(97, function() {
              return Vo(), null;
            })), Me = Me.nextEffect;
          }
        }
        ...
        function _s(e, t, n) {
          var r = new Vu(e, t, n = n != null && n.hydrate === !0), i = nr(3, null, null, t === 2 ? 7 : t === 1 ? 3 : 0);
        ...
        var Gl, xs, Yu = { Events: [oo, Qn, ni, le, I, jr, function(e) {
          Yn(e, Aa);
        ...
        xs = (Gl = { findFiberByHostInstance: Ir, bundleType: 0, version: "16.14.0", rendererPackageName: "react-dom" }).findFiberByHostInstance, function(e) {
          ...
          return xs ? xs(e) : null;
        }, findHostInstancesForRefresh: null, scheduleRefresh: null, scheduleRoot: null, setRefreshHandler: null, getCurrentFiber: null })), s.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Yu, s.createPortal = Ql, s.findDOMNode = function(e) {
          if (e == null) return null;
...
const vf = (ke) => ($.isArray(ke) || (ke = [ke]), ke.map((H) => (typeof H == "string" && (H = { button: H }), H))), su = (ke) => ke.map((H) => vf(H)), kf = su([
  ...
  for (const [H, E] of Object.entries(CKEditor5))
    if (typeof E == "object") {
  ...
  ke.pluginNames && ke.pluginNames.forEach((H) => {
    ...
    Ps.push(E);
  }), ke.toolbarItems && (ke.toolbarItems = su(ke.toolbarItems), kf.push(...ke.toolbarItems)), ke.pluginNames && ke.pluginNames.length && ke.toolbarItems && ke.toolbarItems.length && lu.push({
...
}, Of = () => Ps.map((ke) => ke.pluginName), Pf = async function(ke, H) {
  let E = Ps;
  const s = [];
  H.toolbar && s.push(
    ...lu.filter(
  ...
  const d = await rc.create(
    ke,
    Object.assign({ plugins: E }, H)
  );
  return Craft.showCkeditorInspector && Craft.userIsAdmin && yf.attach(d), d.editing.view.change((u) => {
  ...
  }), E.includes(Os) && Ef(d), E.includes(nu) && _f(d, H), xf(d, E), d;
};
export {
  Pf as create,
  au as localizedRefHandles,
  Of as pluginNames,
  Tf as registerPackage,
  Cf as setLocalizedRefHandles,
  kf as toolbarItems
};
